...
Route::get('locals/@{username}/locals', 'LocalController@getGirls');
Route::put('locals/@{username}/locals/store', 'LocalController@postGirls');
Route::put('locals/@{username}/locals/create', 'LocalController@postCreateGirls');
