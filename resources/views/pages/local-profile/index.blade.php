...
@section('title', __('buttons.locals')) 
                    ...
                    <div class="left-sidebar">
                        ...
                        <div class="shop-layout">
                            ...
                            <div class="layout-list">
                                <ul>
                                    <li>
                                        <?php $num = 1; ?> @foreach($types as $type) @php $var = 'name_'. config()->get('app.locale'); @endphp
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a class="a-img"><img class="primary-img" src="{{ $local->photos. '/nth/0/-/resize/263x300/-/overlay/b423f7a8-2a4f-43e8-acfe-4eb6fe21f7de/70x35/180,260/70p/' }}" alt="" />
                                                        </a>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="single-shop">
                                                <div class="single-product">
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="product-img">
                                                            <a class="a-img"><img class="primary-img" src="{{ $local->photos. '/nth/0/-/resize/263x300/-/overlay/b423f7a8-2a4f-43e8-acfe-4eb6fe21f7de/70x35/180,260/70p/' }}" alt="" /></a>
                                                        </div>
                                                    </div>
