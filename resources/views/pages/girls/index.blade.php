										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product">
												<div class="product-img">
													<a class="a-img"><img class="primary-img" src="{{ $user->photos . 'nth/0/-/resize/263x300/-/overlay/b423f7a8-2a4f-43e8-acfe-4eb6fe21f7de/70x35/180,260/70p/' }}" alt="profile image" />
													</a>
												</div>
										...
										<div class="row">
											<div class="single-shop">
												<div class="single-product">
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
														<div class="product-img">
															<a class="a-img" href="shop.html#"><img class="primary-img" src="{{ $user->photos . 'nth/0/-/resize/263x300/-/overlay/b423f7a8-2a4f-43e8-acfe-4eb6fe21f7de/70x35/180,260/70p/' }}" alt="profile image" />
															</a>
														</div>
													</div>
