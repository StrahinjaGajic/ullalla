...
class LocalController extends Controller
{
    ...
    public function postCreate(Request $request)
    {
        ...
        try {                        
            ...
            $user->photo = $user->photo. '-/overlay/f90362fd-8c5f-4daf-8c1b-7f1ca3ca90f8/120x25/150,140/50p/';
    ...
    public function postGallery(Request $request)
    {
        ...
        $local->photo = $local->photo. '-/overlay/f90362fd-8c5f-4daf-8c1b-7f1ca3ca90f8/120x25/150,140/50p/';
